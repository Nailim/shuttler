...
# arg_list{2} - paht to rot data file
...
# get rot data
[rotTime,rotX,rotY,rotZ] = rotGetData(arg_list{2});

# prepare sample count
sampleCount = [1:length(rotTime)];

# plot rot sample timestamp rotph
figure;
plot(((rotTime-msnTime_start)/1000), sampleCount);	# timestamps in seconds
axis tight;
...
figure;
plot(((rotTime-msnTime_start)/1000), [(rotTime-msnTime_start)(2:end) (rotTime-msnTime_start)(end)]-(rotTime-msnTime_start) );	# timestamps in seconds
axis tight;
...
# plot X rotph
figure;
plot(((rotTime-msnTime_start)/1000), rotX);	# unit in seconds
axis tight;
...
# plot Y rotph
figure;
plot(((rotTime-msnTime_start)/1000), rotY);	# unit in seconds
axis tight;
...
# plot Z rotph
figure;
plot(((rotTime-msnTime_start)/1000), rotZ);	# unit in seconds
axis tight;
