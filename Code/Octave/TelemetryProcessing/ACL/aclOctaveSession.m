...
sampleCount = [1:length(aclTime)];

# plot acl sample timestamp graph
figure;
plot(((aclTime-msnTime_start)/1000), sampleCount);	# timestamps in seconds
axis tight;
...
figure;
plot(((aclTime-msnTime_start)/1000), [(aclTime-msnTime_start)(2:end) (aclTime-msnTime_start)(end)]-(aclTime-msnTime_start) );	# timestamps in seconds
axis tight;
...
# plot X graph
figure;
plot(((aclTime-msnTime_start)/1000), aclX);	# m/ss in seconds
axis tight;
...
# plot Y graph
figure;
plot(((aclTime-msnTime_start)/1000), aclY);	# m/ss in seconds
axis tight;
...
# plot Z graph
figure;
plot(((aclTime-msnTime_start)/1000), aclZ);	# m/ss in seconds
axis tight;
